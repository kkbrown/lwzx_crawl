...
def fetch_xinjiang_event_data(limit=20, page=1):
    ...
    """
    url = "https://cx.lnjttz.cn:1443/event_info/show"
    params = {
        'limit': limit,
        'page': page
    }
...
def run_task():
    try:
        ...
        logging.info(f"成功采集辽宁高速路况：{len(valid_data)} 条，异常：{len(error_log)} 条")
